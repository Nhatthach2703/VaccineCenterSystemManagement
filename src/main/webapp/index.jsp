                            ...
                            <div class="card h-100 p-3 swiper-slide"style="width: 25rem;border-width: 2px;border-color: black">
                                ...
                                <a href="VaccineDetailsServlet?vaccineID=${vaccines.vaccineID}">
                                    ...
                                    <div class="image-content">
                                        ...
                                        <img class="card-img-top" src="uploads/${vaccines.image}" alt="Vaccine Image" width="400" height="180"/>

                                    </div>
                                    <div class="card-content mt-2">
                                        <h4 class="title" style="font-family: 'Tilt Neon', sans-serif">${vaccines.name}</h4>               
                                        <p class="description">Nguồn gốc: ${vaccines.source}</p>
                                        <p class="description text-justify text-dark">${fn:substring(vaccines.summary, 0, 200)}<span>...</span></p>
                                    </div>
                                </a>
                                ...
                                <div class="testimonial-wrap">
                                    <div class="testimonial-item">
                                        ...
                                        <p>
                                            ...
                                            culpa nulla illum cillum fugiat legam esse veniam culpa
