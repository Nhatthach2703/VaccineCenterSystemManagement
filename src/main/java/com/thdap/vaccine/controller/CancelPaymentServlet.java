 ...
 * @author Xuan Vinh
 */
@WebServlet(name = "CancelPaymentServlet", urlPatterns = {"/CancelPaymentServlet"})
public class CancelPaymentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CancelPaymentServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CancelPaymentServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("00".equals(code) && "true".equals(cancel) && "CANCELLED".equals(status) && orderInfoIDStr.equals(orderCode)) {
            // Delete the temporary reservation
            OrderVaccineInfoDAO orderDao = new OrderVaccineInfoDAO();
            orderDao.deleteOrderByOrderInfoID(orderInfoID);
        }
        ...
        response.sendRedirect("paymentCancelSuccess.jsp");
        return;
    }
