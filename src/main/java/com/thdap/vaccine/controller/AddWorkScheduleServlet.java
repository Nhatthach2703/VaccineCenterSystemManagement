...
//        processRequest(request, response);
        ...
        WorkSchedule workSchedule = new WorkSchedule(roomID, shiftID, doctorID, workLocationID, date, workType);
        
        workScheduleDAO.addWorkSchedule(workSchedule);
        
        int workScheduleID = workScheduleDAO.getWorkScheduleID(roomID, shiftID, doctorID, workLocationID, date, workType);
